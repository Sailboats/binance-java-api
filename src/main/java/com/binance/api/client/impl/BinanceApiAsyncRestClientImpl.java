...
public class BinanceApiAsyncRestClientImpl implements BinanceApiAsyncRestClient {
  ...
  @Override
  public void withdraw(String asset, String address, String amount,String network, String name, String addressTag, BinanceApiCallback<WithdrawResult> callback) {
    binanceApiService.withdraw(asset, address, amount, network, name, addressTag, BinanceApiConstants.DEFAULT_RECEIVING_WINDOW, System.currentTimeMillis())
        .enqueue(new BinanceApiCallbackAdapter<>(callback));
  }
